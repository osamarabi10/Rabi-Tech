...
| 5. Broadcast completion | M | **Complete; measured 2026-08-31** | Existing OpenWA campaign path; Meta templates are not required for OpenWA-only work | OpenWA only. Meta business-initiated sends remain blocked. |
| 6. Contacts merge and export | M | **Complete; measured 2026-08-31** | Existing Contact, composite child foreign keys, and role permissions | No migration was needed. Merge history/undo remains a later decision. |
